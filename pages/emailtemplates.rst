...
.. image:: ../images/mail_template_01.jpg

To edit an email template, you click on the subject.

On the right side of the page, you can see the list of available tags which you can insert into email subject and body. These tags will be replaced by actual info before email is sent. For example, {order_amount} will be replace by order's amount (like $50.00).

.. image:: ../images/mail_template_02.jpg